...
namespace CrudeProduto.Controllers
{
    public class ProdutosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Descricao,IdCategoria,IdFornecedor")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Descricao,IdCategoria,IdFornecedor")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
